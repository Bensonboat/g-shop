...
class DogItemList extends React.Component{
    ...
    render(){
        ...
        let AddToCartList = arrDog.map((item) => {
        ...
        return (
            <div class='item-list'>
                ...
                <div class='item-list-display' onClick={this.showSelectionList}>
                    ...
                    <ItemBlock name='name2' flavor='chicken' price='300' discount='2%' url='https://i.pinimg.com/736x/87/8a/10/878a10f4f80acba3e37eb394692135db.jpg'getData={this.dataFromChild} AddToCart={this.AddToCart} />
                    <ItemBlock name='name3' flavor='chicken' price='300' discount='2%' url='https://i.pinimg.com/originals/c5/f1/40/c5f140491dc2c1fb85458c3ef26080a0.jpg'getData={this.dataFromChild} AddToCart={this.AddToCart}/>
                    <ItemBlock name='name4' flavor='chicken' price='300' discount='2%' url='https://i.pinimg.com/736x/87/8a/10/878a10f4f80acba3e37eb394692135db.jpg' getData={this.dataFromChild} AddToCart={this.AddToCart}/>
                    <ItemBlock name='name5' flavor='chicken' price='300' discount='2%' url='https://i.pinimg.com/736x/87/8a/10/878a10f4f80acba3e37eb394692135db.jpg'getData={this.dataFromChild} AddToCart={this.AddToCart}/>
                    <ItemBlock name='name6' flavor='chicken' price='300' discount='2%' url='https://i.pinimg.com/originals/c5/f1/40/c5f140491dc2c1fb85458c3ef26080a0.jpg'getData={this.dataFromChild} AddToCart={this.AddToCart}/>
                    <ItemBlock name='name7' flavor='chicken' price='300' discount='2%' url='https://i.pinimg.com/736x/87/8a/10/878a10f4f80acba3e37eb394692135db.jpg' getData={this.dataFromChild} AddToCart={this.AddToCart}/>
...
的性示物來腦相器；路法一認總實但各到兒如、調步是中賽防即不他長無一年上中排法的及感參思代？業往的毒選師然，不安知甚……並種臺庭交少活認理是告苦就書種！易大位不賣健詩落人生無同英。黑們約變找過他不管預酒金。'/>
                ...
                <div class='add-to-cart-list' id='add_to_cart_list' style={{display:'none'}}>
                    {AddToCartList}
                </div>
            </div>
        )
